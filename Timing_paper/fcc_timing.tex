...
For particle identification in realistic collider environments, 1~GeV range momentum range is rather low. 
...
As an example, a $d^{\pm}$ can be identified and separated from pions for momentum less than 1~GeV using the TOF.
